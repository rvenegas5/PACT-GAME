          ...
          {option ? (
            <>
              <span className="message-modal">
                Felicidades ha acertado en la respuesta
              </span>

              <img
                className=""
                src={require("../../assets/icons/plus2.png")}
                style={{ width: "15vw", height: "26vh" }}
                alt="especial"
              ></img>
            </>
          ) : (
            <>
              ...
              <p className="message-modal">
                Haz seleccionado una respuesta incorrecta
              </p>
              <img
                className=""
                src={require("../../assets/icons/sadface2.png")}
